...
public class CardRequestTest {
    ...
    public void testCardRequestWithoutCheckbox() {
        ...
        $("[data-test-id=phone] input").setValue("+79991111111");
        $("button").click();
        $("[data-test-id=agreement]").shouldBe(Condition.exactText("Я соглашаюсь с условиями обработки и использования моих персональных данных и разрешаю сделать запрос в бюро кредитных историй"), visible);
    }
}
